...
@Service
public class SmsNotificationService implements INotification<SmsNotification>  {
	...
	@Override
	public SmsNotification add(SmsNotification notif) {
		try {
			...
			smsNotiRepo.save(notif);
			System.out.println("Destinataire   :" + smsNotiRepo.findById(notif.getId()).toString());
	...
	@Override
	public SmsNotification update(SmsNotification notif) {
		SmsNotification updatedNotif = getById(notif.getId());
	...
	public List<SmsNotification> getAll() {
		return smsNotiRepo.findAll();
	}

	@Override
	public SmsNotification getById(long id) {
		// TODO Auto-generated method stub
		return smsNotiRepo.findById(id).orElseThrow(RuntimeException::new);
	}

	@Override
	public List<SmsNotification> getByStatus(String status) {
		// TODO Auto-generated method stub
		return smsNotiRepo.findByStatus(status);
	}

	@Override
	public List<SmsNotification> getByFrequence(String freq) {
		// TODO Auto-generated method stub
		return smsNotiRepo.findByFrequence(freq);
	}

	@Override
	public SmsNotification sendNow(SmsNotification notif) {
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("fail to send sms: " + e.getMessage());
		}
		return notif;
	}
